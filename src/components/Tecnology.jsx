      ...
      <Container className="relative">
        <div className="w-full mx-auto text-center">
          ...
          <div className="flex justify-center mt-8 space-x-6">
            <SiElixir className="fill-white h-14 w-14" />
            <FaNodeJs className="fill-white h-14 w-14" />
            <FaReact className="fill-white h-14 w-14" />
            <FaVuejs className="fill-white h-14 w-14" />
            <SiTypescript className="fill-white h-14 w-14" />
          </div>
        </div>
      </Container>
    </section>
