...
const features = [
  ...
  },
  {
    ...
    description:
      "Envie seu aplicativo móvel para Android e iOS para o mercado de uma só vez com as tecnologias Ionic ou React Native.",
      ...
      <Container className="relative">
        <div className="max-w-2xl md:mx-auto md:text-center xl:max-w-none">
          ...
          <p className="mt-6 text-lg tracking-tight text-blue-100">
            Encontre o seu serviço de desenvolvimento de software
          </p>
        </div>
        <Tab.Group
          as="div"
