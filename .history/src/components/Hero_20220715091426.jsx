  ...
  return (
    <Container className="pt-20 pb-16 text-center lg:pt-32">
      <h1 className="max-w-4xl mx-auto text-5xl font-medium tracking-tight font-display text-slate-900 sm:text-7xl">
        Construindo{' '}
        <span className="relative text-blue-500 whitespace-nowrap">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
          ...
          <span className="relative">software inovador</span>
        </span>{' '}
        para você crescer.
      </h1>
      ...
      <div className="flex justify-center mt-10 gap-x-6">
        <Button className="px-12 py-4 text-xl" href="#contato">
          Entre em contato
        </Button>
      </div>
      <div className="mt-36 lg:mt-44">
        <p className="text-base uppercase font-display text-slate-900">
